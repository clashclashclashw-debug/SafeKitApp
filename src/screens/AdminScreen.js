    ...
    return (
      <>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 12 }} contentContainerStyle={{ gap: 8 }}>
          {[
            { id: 'nome', label: '🔤 Nome' },
            { id: 'preco_maior', label: '💰 Preço +' },
            { id: 'preco_menor', label: '🏷️ Preço -' },
            { id: 'stock_menor', label: '⚠️ Stock Baixo' }
          ].map(s => (
      ...
      <>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 14, marginTop: -4 }} contentContainerStyle={{ gap: 8 }}>
          {[
            ...
            { id: 'preco_maior', label: '💰 Maior Valor' },
            { id: 'preco_menor', label: '📉 Menor Valor' }
          ].map(s => (
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.topbar}>
        ...
        <TouchableOpacity onPress={handleResetDb}>
          <Text style={[styles.adminBadge, { backgroundColor: 'rgba(248,81,73,0.15)', color: colors.red }]}>
            🔄 REPOR DB
          </Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  adminTabActive: { backgroundColor: colors.accent, borderColor: colors.accent },
